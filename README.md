...
-Golge Linux Arch KDE : kde masaüstü yüksek iso boyutu günlük kullanım için özelleştirilmiştir hem liveuser hemde tam ve kolay kurulum(calamares) destekler (geliştirilme aşamasında)
